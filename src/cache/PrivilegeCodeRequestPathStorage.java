...
public final class PrivilegeCodeRequestPathStorage {
	...
	private static final int _admin_permit_user_operation = 5;
	private static final int _admin_permit_role_operation = 6;
	private static final int _admin_permit_admin_operation = 7;
	private static final int _admin_permit_privilege_operation = 8;
	private static final int _admin_permit_qualificationtype_operation = 9;
	private static final int _admin_permit_problemtype_operation = 10;
	private static final int _admin_permit_complaint_get = 11;
	private static final int _admin_permit_complaint_operation = 12;
	private static final int _admin_permit_qualificationrequest_get = 13;
	private static final int _admin_permit_qualificationrequest_verify = 14;
	private static final int _admin_permit_system_config_get = 15;
	private static final int _admin_permit_system_config_set = 16;
